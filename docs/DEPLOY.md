...
GAS 첫 호출 시 자동 시드:
- `강사`: 4명(가나다순)
- `설정`: `rate.explain=30000`, `rate.other=20000`, `weeklyCap=20`, `admin.whitelist=i20091119@gmail.com`
